...
init python:
    ...
    renpy.music.register_channel("jump3", mixer="music", tight=True)
    renpy.music.register_channel("jump4", mixer="music", tight=True)
    renpy.music.register_channel("jump5", mixer="music", tight=True)
    renpy.music.register_channel("jump6", mixer="music", tight=True)
    renpy.music.register_channel("jump7", mixer="music", tight=True)
    renpy.music.register_channel("jump8", mixer="music", tight=True)
    renpy.music.register_channel("jump9", mixer="music", tight=True)
    renpy.music.register_channel("jump10", mixer="music", tight=True)
    renpy.music.register_channel("jump11", mixer="music", tight=True)
    renpy.music.register_channel("jump12", mixer="music", tight=True)
