...
label mstory_ch3:
    ...
    a cm "..."
    a dist oe om "I don't have an answer for that."
    a turned neut "There's a rumor going around, they think I'm in love with the principal."
    show aoruguri cm
    m "That's called a pedophile."
    a cross "No, that's called a ephebophile."
    show aoruguri cm
    m "Ephe-what?"
    a cm "Trust me, it's not used often."
    show aoruguri cm
    m "Neither is your name."
    m "No offense."
    a turned om "None taken."
    a cross "As I was saying, my true feelings are actually the opposite of what people are saying."
    a angr "I hate the principal with every fiber of my being!"
    a turned rhip "And yet, I have to tolerate him because...!"
    a rdown ce cm "..."
    a dist oe om "Because he provides for me..."
    a rhip ce "I'm homeless."
    a rdown "I live within this school."
    a rhip lhip neut oe "And no, I don't mean the dorms."
    a ce "I'm quite literally broke."
    a ldown rdown "And therefore, I've become a test subject in all his little experiments about control."
    a angr oe "Speaking of, I have another experiment tomorrow.  That's gonna be fucking fun!"
    show aoruguri ce cm
