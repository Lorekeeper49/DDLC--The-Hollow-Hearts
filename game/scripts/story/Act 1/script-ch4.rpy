label act1_ch4_main:
    ...
    show sayori neut
    "She puts her bow on a rope that takes it away?"
    t "Uh, where did that go?"
    s "In my storage."
    t "Uh what?"
    s curi "You don't know about it?"
    t "No?"
    s rdown "The company certainly thought you did."
    s neut "They're testing new technology called the system."
    t "Isn't that already a thing used in other sectors or something?"
    s rup "It wouldn't work for some for some reason, including us, so they've been on working on an artificial workaround for centuries."
    s "Now they are finally having people test a working version."
    t "About time."
    s "Right now, me, Aoruguri, and Monika are testers.  I'll be sure to make you an official tester by tomorrow."
    t "Okay, thanks, I might need that."
    ...
    t "Is it possible you could be talking about Aoruguri?"
    s neut rup "Definitely possible, but also unsure..."
