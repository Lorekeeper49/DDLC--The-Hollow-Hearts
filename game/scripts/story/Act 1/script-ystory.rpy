...
label ystory_ch2:
    ...
    lil "Ĩ̵͓̹̂ ̸̤͎̿ạ̷̇m̷̟̮̿̚ ̸͚̤̓i̵͓̣͋n̷͇̳̂d̷̲͊ë̴͔e̵̬̓d̵͔̦̊̀ ̵͕͇̄a̷͔͔̕ ̵͖̯͌l̴̦͋͝ï̷̝̌f̶̼̣̏e̶͙͠l̶̢̂e̷̝̜͐̇s̷̗̬͑̌s̵̻̪̽̽ ̶̟̤̂̓d̸̩̲́͊o̵̼͔͊l̷̞̚l̸͍̊.̸̱̭̒"
    ...
    lil "I̶̭̊̌ ̶̞̮͗ḋ̸̝o̶̦̳̐̚ṅ̵̬'̷̺̲̈́t̴̼̾ ̸̢̊w̶̩̥͘ã̸͜n̵̜̣̈͝ť̵̟̫̊ ̷̰̦͛t̴͉͘ő̴́͜ ̸̛͔̓ḅ̴̋͝e̷̡̋ ̶̧̘̕h̴̩͔͒͘u̸̮͐̕ṁ̸͉́a̷̜̿͝n̴̪̹̋!̶̽́ͅ"
    lil "I̸̗͒̚t̵̗̹̊̋ ̵̝̥͛m̴̢̔̚ḁ̵̘͆́k̷̦͛e̴̬̽͜s̷͐ͅ ̵̢̰̈́̆m̷͔͋ȩ̸̮̎ ̸͉͙̚s̸̮͂ĩ̴̪̦c̷̯̦̏k̴͉̐̆!̴̓ͅ"
    lil "L̸̯̔i̶̪͑͛t̸̰̼̄̾ḙ̵̳̇͠ŗ̴̖̓a̸͉͘l̴͙̎̀l̸̼̟̊̚ý̷̧̱ ̷̠͛̓ś̴̝̄í̸̟c̵̲̠͛̓k̸̲̙̃̓!̷̹͛"
    ...
    lil "A̴̘͓͛Ĺ̴̗́Ḽ̵̻͆͝ ̸̰̂B̵̨̪́E̵͕̊Ċ̶̞̠͒Å̶̩U̶͔̝̎S̶̪̖͛̆Ě̸͚͎ ̴̜͐̎H̵̹͋͝E̵̼̓̕ ̵̣̔F̶̭̪́͘Õ̸͚R̷̦̚Ĉ̵͎̞̒Ȅ̷͉̮̄D̶̤̀̇ ̸̯̱̉Ḿ̸̫E̷̞̿ ̷̫̺̚T̷̠̦̈́O̴̩͒̎ ̶̼͒̽Ȃ̶̧̆ͅC̷͎̯͐͠T̶͉̅ ̷̣̣̑L̸̞̳̐́Ȋ̵̹Ḱ̴͕̇E̸̯͑͗ ̷̠̉͗T̶̺͒̔Ḩ̵͉̓͘Ệ̵͊ ̵̨̐͝ͅḎ̴̒Ȏ̷̱̓ͅL̷̨̈́̊L̴͌̑͜ ̸̤̖̑T̸͚͈̈́̓H̸̝̀Ȁ̶̦̳T̷̠͕̂ ̶̢̞͋͝Ĩ̶̮͉ ̴̨̑̋A̴͙̅̑M̸̫̮̂̔!̵̘̟͑̅"
    ...
    lil "Not this."
    lil "The worst part is, n̶͔̖̽ȍ̸̦ ̷̜̩͝ō̶̮̑ṇ̶̝̕e̴̻̓ ̸̞́c̴̘͌a̷̭͓̚n̷̺̏ ̴̤̼̈́̊s̷̟̓͊ḛ̶̞͆ḙ̸̈́ ̴͍̼͊͐m̴̼͍̏͝y̶̡̳̏ ̵̯̏t̵̻̂͋ṛ̴̑̀ȗ̵̞̳͘e̸̦̲̕ ̷̢̙̀͆f̸̤̬̃̔ȏ̶̻̎r̸̙͊m̵̯̈́.̷̲̟͝"
    lil "I̶̳̽͝'̶̧̔m̸̱̼͠ ̴̪̿i̴̬͖͛̚n̴̫̈́͝ ̸̲̃ͅm̵̗̘̓y̸͈͊ ̸̪͉̆t̶̥̰̾̈́r̷̪͐͘ͅu̴̯̳̔͘ê̸̡̫ ̶͉̈̾f̴̖̙̅͝o̷͎͒r̶̳̱͂m̶͖̭̈ ̵̠͆r̵̡̈́ǐ̸͕g̴̹̦̽̃h̶̙͒t̵̙̾ ̶̭̿n̸̠͋̚o̸̘͐̽ẅ̵́̃͜ ̷̧̭̃ã̴̜n̴̫̩͑d̴̟͖̀̽.̵͔͖͒͗.̵̝͊.̶̮̊"
    ha "I can't see it."
    "I nod."
    lil "No one will believe me if I tell them."
    lil "He's controlling me against my will, and I... hate it!"
    lil "I̷̥̓̿ ̵͙͔͋j̶͚̰̆͝ṳ̶̪̏s̵͉̓t̴̞͆ ̵̘͒͆ẃ̴͓̔ă̵̜̦ň̵̺̞͋ṫ̸̜͖ ̶̦̓ȏ̵̪u̵͎͌ͅṭ̵͛.̶̢̀"
    lil "I̸͉͆̓ ̶̢̎͌j̷̭̼͗̓u̸̧̠͊s̴̫̈ť̷̢̙ ̴͇͔̏w̷̫͛̉ä̵̠̦́n̸̖̳̑t̴̬̕ ̵̣͑ḧ̵͔́ī̷̙̮m̵͓̓͌ ̶̡̆̊d̵̹͊͘e̵͇̅̈́a̸͉͂̌d̷̘̈́.̸̹̝͝"
    ha "..."
