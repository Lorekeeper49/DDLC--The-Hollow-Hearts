...
label tstory_ch2:
    ...
    call showlocation("Palace Factories Inc.\n{size=25}株式会社宮殿工場{/size}","September 29, 2018\n{size=15}2018年9月29日{/size}",20*60+4+57/60.0,"bg factory")
    $ pla = "Worker"
...
label tstory_ch3:
    play ambience factory
    scene bg factory with dissolve_scene_half
    call showlocation("Palace Factories Inc.\n{size=25}株式会社宮殿工場{/size}","October 1, 2018",20*60+4+57/60.0,"bg factory")
...
label tstory_ch5:
    play ambience factory
    scene bg factory with dissolve_scene_half
    call showlocation("Palace Factories Inc.\n{size=25}株式会社宮殿工場{/size}","October 2, 2018",20*60+4+57/60.0,"bg factory")
    s "It is done."
    t "Thank you."
