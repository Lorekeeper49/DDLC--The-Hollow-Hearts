screen sewer_hall:
    ...
    button xcenter 750 ycenter 350 xysize (150, 100) action Call("call_inventory", If(selected_item == "Factory Key", [Play("sound", audio.door), Call("next_location", "factory")], Call("locked", "sewer_hall")))
