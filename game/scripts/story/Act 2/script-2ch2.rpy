...
label act2_ch2_run:
    ...
    a "*Sigh*"
    a "Fine, continue."
    ak "As you know, my father is a narcissistic psychopath."
    ak "He's killed Taiyen's entire family."
    ak "So you can guess who..."
    ak "You can guess..."
    a "I can guess who killed Kotonoha?"
    ak "...Yes..."
    ak "And... I hate to break it to you..."
    ak "But this is all the fault of the Sakura family."
    "Stunned, I set down my tools and focus my full attention on Akira."
    ak "I want to preface this by saying that they didn't do it on purpose..."
    ak "There's just a lot they didn't realize."
    ak "...Supposedly."
    ak "They didn't give me all the details."
    a "Well, what details {i}did{/t} they give you?"
    "He thinks for a second."
    ak "My father was a volunteer test subject of an experiment codenamed 'Breaker'."
    ak "It was to be made as a voluntary thing to have people change their attribute easily."
    ak "However, it went horribly."
    ak "TEST ONE, TWO, and THREE...  RESULTS: Normal people turned into completely different people."
    ak "My father was ONE."
    ak "And before you ask, your little fire stunt 3 years ago did not kill him like it should've."
    a "So even crushing him with debris wasn't enough?"
    ak "Apparently not..."
    ak "*Long sigh*"
    ak "To be honest, he doesn't deserve death, because this isn't who he is..."
    ak "But he also needs death for that same reason."
    ak "Hope that makes sense."
    a "It does."
    "Almost feel sorry for him now."
    ak "Just got one question to ask you:"
    ak "Do you hate Taiyen now... after what I told you?"
    a "I..."
    "I think for a moment."
    a "If you asked me to, I wouldn't be able to."
    "Why was {i}that{/i} the conclusion I came to?"
    ak "That's good."
    ak "I don't know the specifics of it."
    ak "But I believe... you're going to need him in the future..."
    a "You and me both."
    return