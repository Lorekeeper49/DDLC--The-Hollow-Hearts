...
transform noisefade(t=0, f=5.0, a=1.0):
    alpha 0.0
    t
    linear f alpha a
...
define flashback_start = Fade(0.5, 0.0, 0.5, color="#fff")

define flashback_end = Fade(0.3, 0.0, 0.3, color="#fff")

define flash = Fade(0.3, 0.0, 0.5, color="#fff")
