...
default act2_path_list = [
    {"title": "The Timid Storm", "JP": "小心嵐", "needed choices": ["Hidden Girl Revealed"], "categories": {"HIDDEN GIRL": "revealed"}, "label": "act2", "extra options": []},
    {"title": "The Hidden Girl", "JP": "隠れた少女", "needed choices": ["Hidden Girl Kept Secret"], "categories": {"HIDDEN GIRL": "hidden"}, "label": "act2_alt", "extra options": []},
]
        ...
        viewport:
            ...
            for i in range(len(path_list)):
                for category in path_list[i]["categories"]:
                    $ path_shown = True
                    if globals()[choice_filters[category]["variable to set"]] is not None and globals()[choice_filters[category]["variable to set"]] != path_list[i]["categories"][category]:
                        $ path_shown = False
                        break
                if path_shown:
                    button:
