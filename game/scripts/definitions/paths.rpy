...
default act3_choice_filters = {
    ...
    "BREAKER": { "variable to set": "breaker_found", "JP": "ブレイカー", "hidden": True,
        ...
        {"choice name": "DIDN'T FIND", "JP": "見つからない", "variable value": "didn't find", "needed choices": ["Found Breaker"], "hidden": False}
        ]
    },
...
default act3_path_list = [
    {"title": "The Broken Family", "JP": "壊れた家族", "needed choices": ["Hidden Girl Revealed", "Found Breaker", "Dominion Calm", "Engeki Left"], "categories": {"HIDDEN GIRL": "revealed", "BREAKER": "found", "FRIGHTENED DOMINION": "calm", "UNKNOWN SISTER": "left"}, "label": "act2_path1", "extra options": [], "hidden": False},
    {"title": "The Tragic Past", "JP": "壊れた過去", "needed choices": ["Hidden Girl Revealed", "Found Breaker", "Dominion Burst", "Engeki Left"], "categories": {"HIDDEN GIRL": "revealed", "BREAKER": "found", "FRIGHTENED DOMINION": "burst", "UNKNOWN SISTER": "left"}, "label": "act2_path2", "extra options": [], "hidden": False}, 
    {"title": "The Painful Regrets", "JP": "痛恨", "needed choices": ["Hidden Girl Revealed", "Found Breaker", "Dominion Left Behind", "Engeki Left"], "categories": {"HIDDEN GIRL": "revealed", "BREAKER": "found", "FRIGHTENED DOMINION": "left behind", "UNKNOWN SISTER": "left"}, "label": "act2_path3", "extra options": [], "hidden": False}, 
    {"title": "The Control Experiment", "JP": "CONTROLLERの実験", "needed choices": ["Hidden Girl Revealed", "Dominion Calm", "Engeki Left"], "categories": {"HIDDEN GIRL": "revealed", "BREAKER": "didn't find", "FRIGHTENED DOMINION": "calm", "UNKNOWN SISTER": "left"}, "label": "act2_path4", "extra options": [], "hidden": False}, 
    {"title": "The Rampant Image", "JP": "高慢なイメージ", "needed choices": ["Hidden Girl Revealed", "Dominion Burst", "Engeki Left"], "categories": {"HIDDEN GIRL": "revealed", "BREAKER": "didn't find", "FRIGHTENED DOMINION": "burst", "UNKNOWN SISTER": "left"}, "label": "act2_path5", "extra options": [], "hidden": False}, 
    {"title": "The Left Paths", "JP": "残された道", "needed choices": ["Hidden Girl Revealed", "Dominion Left Behind" "Engeki Left"], "categories": {"HIDDEN GIRL": "revealed", "BREAKER": "didn't find", "FRIGHTENED DOMINION": "left behind", "UNKNOWN SISTER": "left"}, "label": "act2_path6", "extra options": [], "hidden": False}, 
    {"title": "The Missing One", "JP": "行方不明", "needed choices": ["Hidden Girl Revealed", "Found Breaker", "Dominion Calm", "Engeki Stayed"], "categories": {"HIDDEN GIRL": "revealed", "BREAKER": "found", "FRIGHTENED DOMINION": "calm", "UNKNOWN SISTER": "stayed"}, "label": "act2_path7", "extra options": [], "hidden": False}, 
    {"title": "The Curse Breaker", "JP": "呪いのブレイカー", "needed choices": ["Hidden Girl Revealed", "Found Breaker", "Dominion Burst", "Engeki Stayed"], "categories": {"HIDDEN GIRL": "revealed", "BREAKER": "found", "FRIGHTENED DOMINION": "burst", "UNKNOWN SISTER": "stayed"}, "label": "act2_path8", "extra options": [], "hidden": False}, 
    {"title": "The Timid Love", "JP": "小心恋", "needed choices": ["Hidden Girl Revealed", "Found Breaker", "Dominion Left Behind" "Engeki Stayed"], "categories": {"HIDDEN GIRL": "revealed", "BREAKER": "found", "FRIGHTENED DOMINION": "left behind", "UNKNOWN SISTER": "stayed"}, "label": "act2_path9", "extra options": [], "hidden": False}, 
    {"title": "The Killed Death", "JP": "死亡", "needed choices": ["Hidden Girl Revealed", "Dominion Calm", "Engeki Stayed"], "categories": {"HIDDEN GIRL": "revealed", "BREAKER": "didn't find", "FRIGHTENED DOMINION": "calm", "UNKNOWN SISTER": "stayed"}, "label": "act2_path10", "extra options": [], "hidden": False}, 
    {"title": "The Deadly Storm", "JP": "致命的嵐", "needed choices": ["Hidden Girl Revealed", "Dominion Burst", "Engeki Stayed"], "categories": {"HIDDEN GIRL": "revealed", "BREAKER": "didn't find", "FRIGHTENED DOMINION": "burst", "UNKNOWN SISTER": "stayed"}, "label": "act2_path11", "extra options": [], "hidden": False}, 
    {"title": "The Lost Ones", "JP": "迷える人々", "needed choices": ["Hidden Girl Revealed", "Dominion Left Behind" "Engeki Stayed"], "categories": {"HIDDEN GIRL": "revealed", "BREAKER": "didn't find", "FRIGHTENED DOMINION": "left behind", "UNKNOWN SISTER": "stayed"}, "label": "act2_path12", "extra options": [], "hidden": False}, 
    {"title": "The Dead Doll", "JP": "死人形", "needed choices": ["Hidden Girl Kept Secret", "Yuri Alive", "Engeki Left"], "categories": {"HIDDEN GIRL": "hidden", "KIND MAN": "followed", "UNKNOWN SISTER": "left"}, "label": "act2_path13", "extra options": [], "hidden": False}, 
    {"title": "The Death Emotions", "JP": "死感", "needed choices": ["Hidden Girl Kept Secret", "Yuri Killed", "Engeki Left"], "categories": {"HIDDEN GIRL": "hidden", "KIND MAN": "ran away", "UNKNOWN SISTER": "left"}, "label": "act2_path14", "extra options": [], "hidden": False}, 
    {"title": "The Lives Taken", "JP": "取られた人生", "needed choices": ["Hidden Girl Kept Secret", "Yuri Alive", "Engeki Stayed"], "categories": {"HIDDEN GIRL": "hidden", "KIND MAN": "followed", "UNKNOWN SISTER": "stayed"}, "label": "act2_path15", "extra options": [], "hidden": False},
    {"title": "The Lone Girl", "JP": "独り少女", "needed choices": ["Hidden Girl Kept Secret", "Yuri Killed", "Engeki Stayed"], "categories": {"HIDDEN GIRL": "hidden", "KIND MAN": "ran away", "UNKNOWN SISTER": "stayed"}, "label": "act2_path16", "extra options": [], "hidden": False}
]
