...
init -1 style main_menu_kan_frame:
    font "mod_assets/fonts/FOT-RodinNTLG Pro EB.otf"
    color "#ffffff80"
    outlines [(0, "#58585800", 0, 0), (0, "#58585800", 0, 0)]
    size 20
        ...
        viewport id "vp":
            ...
            if config.has_music:
                ...
                hbox:
                    ...
                    text _("音楽の音量") yalign 0.75 style "pref_JP_label_text"
                hbox:
                    bar value Preference("music volume")
                hbox:
                    label "Ambience Volume" yalign 0.5
                    text _("環境音の音量") yalign 0.75 style "pref_JP_label_text"
                hbox:
            ...
            if config.has_sound:
                ...
                hbox:
                    ...
                    text _("物音の音量") yalign 0.75 style "pref_JP_label_text"
                hbox:
            ...
            if config.has_voice:
                ...
                hbox:
                    ...
                    text _("声の音量") yalign 0.75 style "pref_JP_label_text"
                hbox:
