layeredimage tetsuo towards:
    ...
    group eyes:
        ...
        attribute oe default if_any(["neut", "angr", "curi", "happ"]):
            "mod_assets/MPT/tetsuo/eyes/e1a.png"
        attribute oe default if_any(["cry"]):
            "mod_assets/MPT/tetsuo/eyes/e1d.png"
        attribute oe default if_any(["nerv", "sad"]):
            "mod_assets/MPT/tetsuo/eyes/e1b.png"
        attribute oe default if_any(["shoc", "vang"]):
            "mod_assets/MPT/tetsuo/eyes/e1c.png"

        attribute ce if_any(["neut", "angr", "curi", "happ", "sad", "vang", "nerv", "shoc"]):
            "mod_assets/MPT/tetsuo/eyes/e2a.png"
        attribute ce if_any(["cry"]):
            "mod_assets/MPT/tetsuo/eyes/e2b.png"
    ...
    group mouths:
        ...
        attribute cm default if_any(["neut", "angr", "cry", "curi", "shoc", "sad"]):
            "mod_assets/MPT/tetsuo/mouths/ma.png"
        attribute cm default if_any(["happ", "nerv"]):
            "mod_assets/MPT/tetsuo/mouths/mb.png"
        attribute cm default if_any(["vang"]):
            "mod_assets/MPT/tetsuo/mouths/md.png"

        attribute om if_any(["neut", "angr", "cry", "curi", "nerv", "shoc", "sad", "happ"]):
            "mod_assets/MPT/tetsuo/mouths/mc.png"
        attribute om if_any(["vang"]):
            "mod_assets/MPT/tetsuo/mouths/me.png"
    ...
    group nose:
        ...
        attribute n1:
            "mod_assets/MPT/tetsuo/nose/n1.png"
    ...
    group right:
        ...
        attribute rdown default if_not(["cross"]):
            "mod_assets/MPT/tetsuo/clothes/1r.png"
        attribute rup if_not(["cross"]):
            "mod_assets/MPT/tetsuo/clothes/2r.png"
        attribute cross:
            "mod_assets/MPT/tetsuo/clothes/3a.png"
    ...
    group left:
        ...
        attribute ldown default if_not(["cross"]):
            "mod_assets/MPT/tetsuo/clothes/1l.png"
        attribute lup if_not(["cross"]):
            "mod_assets/MPT/tetsuo/clothes/2l.png"